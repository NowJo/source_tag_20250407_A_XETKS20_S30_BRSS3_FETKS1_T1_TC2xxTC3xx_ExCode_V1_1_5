...
#ifndef __ENDINIT_H__
#define __ENDINIT_H__
...
/* This function can be called by the Tasking compiler during the startup when the endinit protections are disabled. */
void _endinit(void);

/* This function can be called by the Tasking compiler during the startup before entering the main function. */
