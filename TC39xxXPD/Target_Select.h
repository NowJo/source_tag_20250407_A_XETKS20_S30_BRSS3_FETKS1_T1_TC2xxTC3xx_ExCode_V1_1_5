...
/** Compiles for the TC39xX PD targets. */
#define CPUTYPE_TC39X
#define CPUCLASS_TC3XX

/* For the TC39xxX devices the Trace module is not supported. (MCDS cannot be used) */
#define TRACE_NOT_SUPPORTED
...
/** When this define is set for the TC3xx, the ECU SW will try to detect if a TU11 is present by shorting the pins P30.0<->P30.4.
If the TU11 is not detected the LEDs will be configured for the Triboard by default. 
The 2 previous FORCE_*_BOARD_DETECT defines will preeöpt this setting ! */
//#define TU11_PINS_BOARD_DETECTION
