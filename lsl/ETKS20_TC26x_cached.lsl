...
#define CSA_START_TC0     0xD0011000
#define CSA_TC0             64
...
//*** emulation RAM: BF00 0000h - BF0F FFFFh (1024kB) ***
//*** EMURAM section ***
...
memory EMURAM_CODECHECK_PATTERN
{
   ...
   size = 16k;
   type = reserved ram;
   map (dest=bus:mpe:sri, dest_offset=0xBF07C000, size=16k);
}
...
section_layout mpe:vtc:linear
{
  ...
  // FLASH KEY Pattern
  group flash_key (ordered, run_addr=0x800FEFFC)
  {
    select "*.FLASH_KEY";
  }
  ...
  // Cal Params
  group CAL_PARAM (ordered, run_addr=0x80164020)
  {
  ...
  group distabTables (ordered, run_addr = mem:mpe:dspr0[0x2000])
  {
  ...
  group CP_2 (ordered, run_addr=0x80104000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0x80108000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0x8010C000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0x80110000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0x80114000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0x80118000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0x8011C000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0x80120000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0x80124000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0x80128000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0x8012C000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0x80130000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0x80134000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0x80138000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0x8013C000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0x80140000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0x80144000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0x80148000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0x8014C000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0x80150000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0x80154000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0x80158000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0x8015C000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0x80160000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0x80164000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0x80168000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0x8016C000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0x80170000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0x80174000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0x80178000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0x8017C000)
  {
