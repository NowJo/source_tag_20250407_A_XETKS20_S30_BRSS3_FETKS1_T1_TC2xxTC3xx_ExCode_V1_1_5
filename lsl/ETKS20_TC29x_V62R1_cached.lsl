...
section_layout mpe:vtc:linear
{
  ...
  group CP_2 (ordered, run_addr=0x80110000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0x80120000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0x80130000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0x80140000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0x80150000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0x80160000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0x80170000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0x80180000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0x80190000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0x801A0000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0x801B0000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0x801C0000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0x801D0000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0x801E0000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0x801F0000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0x80200000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0x80210000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0x80220000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0x80230000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0x80240000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0x80250000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0x80260000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0x80270000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0x80280000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0x80290000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0x802A0000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0x802B0000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0x802C0000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0x802D0000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0x802E0000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0x802F0000)
  {
