...
#define A1_START_ADDRESS  0x80001000
#define LIBRARIES         0x80002000
#define INTTAB            0x80006000
#define TRAPTAB           0x80008000
...
{
  /* 0x80000000--0x8000001F is reserved for the Boot Header Mode Structure which allows to specifiy a special starting point for the program. */
  /* !! Without at least one valid BMHD the TC2xx variants after the TC2D5 won't boot !! */

  // Boot Mode Header 0
  group BMHD0_DATA (ordered, run_addr=0x80000000)
  {
    // We want to put a BMHD in the 0x80000000 specific area.
  ...
  group BMHD2_DATA (ordered, run_addr=0x8000FFE0)
  {
    select "*.BMHD2";
  }
  ...
  // This BMHD will only be used if none of the first two BMHD are set up correctly.
  group BMHD2_CODE (ordered, run_addr=0x80010000)
  {
  ...
  group DF_ValidatePattern_SaveinCode (ordered, run_addr=0x8000B000)
  {
  ...
  // FLASH KEY Pattern
  group flash_key (ordered, run_addr=mem:mpe:pflash0[0xFEFFC])
  {
    select "*.FLASH_KEY";
  }
  ...
  group DF_ValidatePattern (ordered, run_addr=0x800FFF00)
  {
  ...
  // Cal Params
  group CAL_PARAM (ordered, run_addr=mem:mpe:pflash0[0x164000])
  {
  ...
  group IRAM_befCalib (ordered, run_addr = mem:mpe:dspr0[0x30])
  {
    select "*.IRAM";
  ...
  group distabTables (ordered, run_addr = mem:mpe:dspr0_aftCal)
  {
  ...
  // adaptive Parameters
  group ADAP_PARAM (ordered, run_addr = mem:mpe:dspr0_aftCal[0x8000])
  {
    select "*.ADAP_PARAM";
  }

  // bypass Offsets
  group BYP_OFFSETS (ordered, run_addr = mem:mpe:dspr0_aftCal[0x9000])
  {
  ...
  group LMU_RAM_CodeCheck_Pattern(ordered, run_addr=mem:mpe:lmuram)
  {
  ...
  group CP_1 (ordered, run_addr=0x80100800)
  {
    select "*.calibParam_01";
  }
  group CP_2 (ordered, run_addr=0x80108000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0x80110000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0x80118000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0x80120000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0x80128000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0x80130000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0x80138000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0x80140000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0x80148000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0x80150000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0x80158000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0x80160000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0x80168000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0x80170000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0x80178000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0x80180000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0x80188000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0x80190000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0x80198000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0x801A0000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0x801A8000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0x801B0000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0x801B8000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0x801C0000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0x801C8000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0x801D0000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0x801D8000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0x801E0000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0x801E8000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0x801F0000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0x801F8000)
  {
