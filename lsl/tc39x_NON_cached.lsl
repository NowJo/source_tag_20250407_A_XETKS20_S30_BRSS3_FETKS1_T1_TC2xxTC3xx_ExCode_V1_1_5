...
//**  FILE        :  tc39x.lsl                                               *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC39X                         *
...
# define GTM_MCS_RAM0_SIZE              0x3000
#endif
...
extends gtm31_10
{
        ...
        bus sri
        {
                ...
                map (dest=bus:xc800:code_bus, src_offset=SCR_BASE_ADDR, dest_offset=0, size=32k);
        }
...
#define __CPP_RUN_TIME_ENTRY_FLAG mem:dspr0
        ...
        memory pflash0 // Program Flash CPU0
        {
                ...
                size = 3M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80000000, reserved, size=3M);
        ...
        memory pflash1 // Program Flash CPU1
        {
                ...
                size = 3M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80300000, reserved, size=3M);
        ...
        memory pflash2 // Program Flash CPU2
        {
                ...
                size = 3M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80600000, reserved, size=3M);
                map not_cached (dest=bus:sri, dest_offset=0xa0600000,           size=3M);
        }
        memory pflash3 // Program Flash CPU3
        {
                ...
                size = 3M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80900000, reserved, size=3M);
                map not_cached (dest=bus:sri, dest_offset=0xa0900000,           size=3M);
        }
        memory pflash4 // Program Flash CPU4
        {
                ...
                size = 3M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80c00000, reserved, size=3M);
                map not_cached (dest=bus:sri, dest_offset=0xa0c00000,           size=3M);
        }
        memory pflash5 // Program Flash CPU5
        {
                ...
                size = 1M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80f00000, reserved, size=1M);
                map not_cached (dest=bus:sri, dest_offset=0xa0f00000,           size=1M);
        }
        ...
        memory dflash0_ucb
        {
                ...
                size = 24k;
                type = reserved nvram;
                map (dest=bus:sri, dest_offset=0xaf400400, size=24k-0x400);
        }
        ...
        memory dlmucpu3 // DLMU CPU3
        {
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0030000,           size=64k);
        }
        memory dlmucpu4 // DLMU CPU4
        {
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0100000,           size=64k);
        }
        memory dlmucpu5 // DLMU CPU5
        {
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0110000,           size=64k);
        }
        ...
        memory dam0ram0
        {
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0400000,           size=32k);
        }
        memory dam0ram1
        {
                mau = 8;
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0408000,           size=32k);
        }
        memory dam1ram0
        {
                mau = 8;
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0410000,           size=32k);
        }
        memory dam1ram1
        {
                mau = 8;
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb0418000,           size=32k);
        }
        ...
        memory emem2
        {
                ...
                map not_cached (dest=bus:sri, dest_offset=0xb9200000,           size=1M);
        }
        memory emem3
        {
                mau = 8;
                size = 1M;
                type = reserved ram;
                //map     cached (dest=bus:sri, dest_offset=0x99300000,           size=1M-128k);
                map not_cached (dest=bus:sri, dest_offset=0xb9300000,           size=1M-128k);
        }
