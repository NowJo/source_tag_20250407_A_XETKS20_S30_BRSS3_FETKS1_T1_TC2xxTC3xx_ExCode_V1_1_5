...
################################################################################
#                                                                              #
#    TC39xED / XETKS20 and FETK-S1               |   ETAS GmbH                 #
...
#define CSA_START_TC0     0xD0017000
#define CSA_TC0             64
...
#include "tc37x_fromTC39x.lsl"


//*** emulation RAM: B900 0000h - B92F FFFFh (3072kB) ***
//*** EMURAM section ***
...
memory EMURAM_CODECHECK_PATTERN
{
   ...
   size = 128k;
   type = reserved ram;
   map (dest=bus:mpe:sri, dest_offset=0xB92E0000, size=128k);
}

memory UCB_BMHD_ORIG
{
  mau = 8;
  size = 0x400;
  type = reserved nvram;
  map (dest=bus:mpe:sri, dest_offset=0xaf400000, size=0x400);
}
...
section_layout mpe:vtc:linear
{
  ...
  // Boot Mode Header 0
  group BMHD0_DATA (ordered, run_addr=0xAF400000)
  {
    // We want to put a BMHD in the 0xAF400000 specific area.
  ...
  // UCB_BMHD1
  // The Boot Mode Header 1 is added as a safety.
  // This BMHD will only be used if none of the first two BMHD are set up correctly.
  group BMHD1_DATA (ordered, run_addr=0xAF400200)
  {
    select "*.UCB_BMHD1";
  }

  // Alternate BMHD0
  group Alternate_Boot_Mode_Header_0 (ordered, run_addr=0xA0000000)
  {
    select "*.BMHD0";
  }
  ...
  group LMU_ram (ordered, run_addr = mem:mpe:dlmucpu0[0x4000])
  {
  ...
  group CP_2 (ordered, run_addr=0x80120000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0x80140000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0x80160000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0x80180000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0x801A0000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0x801C0000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0x801E0000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0x80200000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0x80220000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0x80240000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0x80260000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0x80280000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0x802A0000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0x802C0000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0x802E0000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0x80400000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0x80420000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0x80440000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0x80460000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0x80480000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0x804A0000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0x804C0000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0x804E0000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0x80500000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0x80520000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0x80540000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0x80560000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0x80580000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0x805A0000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0x805C0000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0x805E0000)
  {
