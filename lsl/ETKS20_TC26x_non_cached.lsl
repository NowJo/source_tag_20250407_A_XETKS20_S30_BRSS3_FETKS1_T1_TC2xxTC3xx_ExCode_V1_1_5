...
section_layout mpe:vtc:linear
{
  ...
  // Cal Params
  group CAL_PARAM (ordered, run_addr=0xA0164020)
  {
  ...
  group CP_2 (ordered, run_addr=0xA0104000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0xA0108000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0xA010C000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0xA0110000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0xA0114000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0xA0118000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0xA011C000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0xA0120000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0xA0124000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0xA0128000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0xA012C000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0xA0130000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0xA0134000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0xA0138000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0xA013C000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0xA0140000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0xA0144000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0xA0148000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0xA014C000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0xA0150000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0xA0154000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0xA0158000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0xA015C000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0xA0160000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0xA0164000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0xA0168000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0xA016C000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0xA0170000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0xA0174000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0xA0178000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0xA017C000)
  {
