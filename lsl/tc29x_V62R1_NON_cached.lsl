...
#define __CPP_RUN_TIME_ENTRY_FLAG mem:dspr0
        ...
        memory pflash2
        {
                ...
                size = 2M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80400000, reserved, size=2M);
                map not_cached (dest=bus:sri, dest_offset=0xa0400000,           size=2M);
        }
        ...
        memory pflash3
        {
                ...
                size = 2M;
                type = rom;
                map     cached (dest=bus:sri, dest_offset=0x80600000, reserved, size=2M);
                map not_cached (dest=bus:sri, dest_offset=0xa0600000,           size=2M);
        }
