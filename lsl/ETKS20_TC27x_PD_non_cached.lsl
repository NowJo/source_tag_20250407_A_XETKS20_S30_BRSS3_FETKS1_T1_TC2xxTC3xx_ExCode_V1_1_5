...
#include "tc27x_NON_cached_PD.lsl"
...
section_layout mpe:vtc:linear
{
  ...
  group CP_2 (ordered, run_addr=0xA0108000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0xA0110000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0xA0118000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0xA0120000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0xA0128000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0xA0130000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0xA0138000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0xA0140000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0xA0148000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0xA0150000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0xA0158000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0xA0160000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0xA0168000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0xA0170000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0xA0178000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0xA0180000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0xA0188000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0xA0190000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0xA0198000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0xA01A0000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0xA01A8000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0xA01B0000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0xA01B8000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0xA01C0000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0xA01C8000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0xA01D0000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0xA01D8000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0xA01E0000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0xA01E8000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0xA01F0000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0xA01F8000)
  {
