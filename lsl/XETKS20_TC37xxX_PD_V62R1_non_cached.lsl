...
#include "tc37x_fromTC39x_NON_cached.lsl"
...
section_layout mpe:vtc:linear
{
  ...
  group CP_2 (ordered, run_addr=0xA0120000)
  {
    select "*.calibParam_02";
  }
  group CP_3 (ordered, run_addr=0xA0140000)
  {
    select "*.calibParam_03";
  }
  group CP_4 (ordered, run_addr=0xA0160000)
  {
    select "*.calibParam_04";
  }
  group CP_5 (ordered, run_addr=0xA0180000)
  {
    select "*.calibParam_05";
  }
  group CP_6 (ordered, run_addr=0xA01A0000)
  {
    select "*.calibParam_06";
  }
  group CP_7 (ordered, run_addr=0xA01C0000)
  {
    select "*.calibParam_07";
  }
  group CP_8 (ordered, run_addr=0xA01E0000)
  {
    select "*.calibParam_08";
  }
  group CP_9 (ordered, run_addr=0xA0200000)
  {
    select "*.calibParam_09";
  }
  group CP_10 (ordered, run_addr=0xA0220000)
  {
    select "*.calibParam_10";
  }
  group CP_11 (ordered, run_addr=0xA0240000)
  {
    select "*.calibParam_11";
  }
  group CP_12 (ordered, run_addr=0xA0260000)
  {
    select "*.calibParam_12";
  }
  group CP_13 (ordered, run_addr=0xA0280000)
  {
    select "*.calibParam_13";
  }
  group CP_14 (ordered, run_addr=0xA02A0000)
  {
    select "*.calibParam_14";
  }
  group CP_15 (ordered, run_addr=0xA02C0000)
  {
    select "*.calibParam_15";
  }
  group CP_16 (ordered, run_addr=0xA02E0000)
  {
    select "*.calibParam_16";
  }
  group CP_17 (ordered, run_addr=0xA0400000)
  {
    select "*.calibParam_17";
  }
  group CP_18 (ordered, run_addr=0xA0420000)
  {
    select "*.calibParam_18";
  }
  group CP_19 (ordered, run_addr=0xA0440000)
  {
    select "*.calibParam_19";
  }
  group CP_20 (ordered, run_addr=0xA0460000)
  {
    select "*.calibParam_20";
  }
  group CP_21 (ordered, run_addr=0xA0480000)
  {
    select "*.calibParam_21";
  }
  group CP_22 (ordered, run_addr=0xA04A0000)
  {
    select "*.calibParam_22";
  }
  group CP_23 (ordered, run_addr=0xA04C0000)
  {
    select "*.calibParam_23";
  }
  group CP_24 (ordered, run_addr=0xA04E0000)
  {
    select "*.calibParam_24";
  }
  group CP_25 (ordered, run_addr=0xA0500000)
  {
    select "*.calibParam_25";
  }
  group CP_26 (ordered, run_addr=0xA0520000)
  {
    select "*.calibParam_26";
  }
  group CP_27 (ordered, run_addr=0xA0540000)
  {
    select "*.calibParam_27";
  }
  group CP_28 (ordered, run_addr=0xA0560000)
  {
    select "*.calibParam_28";
  }
  group CP_29 (ordered, run_addr=0xA0580000)
  {
    select "*.calibParam_29";
  }
  group CP_30 (ordered, run_addr=0xA05A0000)
  {
    select "*.calibParam_30";
  }
  group CP_31 (ordered, run_addr=0xA05C0000)
  {
    select "*.calibParam_31";
  }
  group CP_32 (ordered, run_addr=0xA05E0000)
  {
